      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden p-7 animate-page-in">
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 8 }}>
            ...
            <div style={{ fontSize: 12, color: 'var(--text3)' }}>
              Data Source: <span style={{ fontWeight: 600, color: 'var(--text2)' }}>QuickBooks Online</span>
            </div>
          </div>
        </div>
        ...
        <div style={{ marginBottom: 28 }}>
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 10, marginBottom: 14 }}>
            ...
            <span style={{ fontSize: 12, color: 'var(--text3)' }}>10 reports · unlock by connecting QuickBooks Online</span>
