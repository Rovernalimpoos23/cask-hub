'use client'
// src/app/(app)/command-center/sales/kpi-dashboard/page.tsx
// CASK Operating System — Sales KPI Dashboard (dedicated live dashboard page)
// Live dashboard backed by Supabase (sales_kpi_data, sales_hot_list, sales_conversions,
// sales_funnel_120, sales_lead_sources, sales_weekly_progress, sales_nps_stats,
// sales_monthly_funnel, sales_referrals_weekly, sales_pit_data). Falls back to seeded
// sample data if the tables are empty or unreachable. Moved off the Sales & Marketing
// landing page into its own page — linked from the "Sales KPI Dashboard" report card.
...
function FloatingSalesAI() {
  ...
  return (
    <>
      ...
      {/* Floating button — always visible on the KPI dashboard */}
      <button
        onClick={() => setOpen(o => !o)}
...
export default function SalesKpiDashboardPage() {
  ...
  return (
    <>
      <TopBar title="Sales KPI Dashboard" subtitle="Live sales performance · Jeff's KPI Tracker · Q2 2026">
        <span
          style={{
            display: 'inline-flex',
            alignItems: 'center',
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden p-7 animate-page-in" style={{ background: 'var(--bg)' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 16, minWidth: 0 }}>
              ...
              <div style={{ minWidth: 0 }}>
                ...
                <div style={{ fontSize: 12, fontWeight: 600, letterSpacing: '1.5px', textTransform: 'uppercase', color: 'rgba(255,255,255,0.55)', marginTop: 7 }}>
                  Live sales performance · Jeff&apos;s KPI Tracker · Q2 2026
                </div>
              </div>
            </div>
        ...
        {loading ? (
          ...
          <>
            ...
            {/* SECTION 6 — Current Week Progress */}
            ...
            {/* SECTION 8 — Monthly Funnel Snapshot */}
            ...
            {/* SECTION 9 — Weekly Referrals Out */}
