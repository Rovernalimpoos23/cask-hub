...
export default function DailyMeetingsPage() {
  return (
    <div className="flex flex-col h-full overflow-hidden">
      <TopBar title="Daily Meetings" subtitle="President Workflow" />
      ...
      <div className="flex-1 overflow-y-auto p-6">
        ...
        >
          ...
          <p className="text-[14px] leading-relaxed" style={{ color: 'var(--text2)' }}>
            Track daily standup recaps, key decisions, and follow-ups. Every daily meeting captured and connected to your bigger goals.
          </p>
        </div>
