...
export default function DepartmentAlignmentPage() {
  return (
    <div className="flex flex-col h-full overflow-hidden">
      <TopBar title="Department Alignment" subtitle="President Workflow" />
      ...
      <div className="flex-1 overflow-y-auto p-6">
        ...
        >
          ...
          <p className="text-[14px] leading-relaxed" style={{ color: 'var(--text2)' }}>
            Department head meetings connected directly to the $20M goal. Every department&apos;s progress visible in one place.
          </p>
        </div>
