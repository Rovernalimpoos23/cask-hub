// src/app/(app)/president/pit-goals/page.tsx
import { TopBar } from '@/components/ui'

export default function PitGoalsPage() {
  return (
    <div className="flex flex-col h-full overflow-hidden">
      <TopBar title="PIT Goals" subtitle="President Workflow" />
      ...
      <div className="flex-1 overflow-y-auto p-6">
        ...
        >
          Personal, Interpersonal &amp; Team Goals
        </h1>
        ...
        >
          ...
          <p className="text-[14px] leading-relaxed" style={{ color: 'var(--text2)' }}>
            Track PIT goals across the leadership team. Personal growth, interpersonal relationships, and team performance — all connected to the quarterly and yearly goals.
          </p>
        </div>
