...
export default function ActiveClientsPage() {
  return (
    <div className="flex flex-col h-full overflow-hidden">
      <TopBar title="Active Clients" subtitle="Customer Journey" />
      ...
      <div className="flex-1 overflow-y-auto p-6">
        ...
        >
          ...
          <p className="text-[14px] leading-relaxed" style={{ color: 'var(--text2)' }}>
            Every active client with their complete meeting history, action items, and workflow progress. One folder per client — everything stays together.
          </p>
        </div>
