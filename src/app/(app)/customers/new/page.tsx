      ...
      <div className="flex-1 overflow-y-auto p-6">
        ...
        >
          ...
          <p className="text-[14px] leading-relaxed" style={{ color: 'var(--text2)' }}>
            Start a new client folder by duplicating the master template. All standard meetings and workflows are pre-loaded — just add the client name and you are ready to go.
          </p>
        </div>
