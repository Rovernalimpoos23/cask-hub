  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-6">
        ...
        >
          Standard Client Workflow Templates
        </h1>
        ...
        >
          <div className="flex items-start justify-between gap-4 mb-4">
            ...
            <span
              ...
              style={{ color: '#92400e', background: 'var(--amber-bg)', border: '1px solid rgba(146,64,14,0.2)' }}
            >
              In Progress
            </span>
          </div>
          <p className="text-[14px] leading-relaxed" style={{ color: 'var(--text2)' }}>
            The master template folder for every new client. Duplicate this for John Smith, Jennifer, or any new customer — same workflow, same meetings, same process every time.
          </p>
        </div>
        ...
        >
          ...
          Planned for May 22, 2026 afternoon session with Calin
        </div>
