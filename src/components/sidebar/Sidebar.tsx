      ...
      >
        <div className="flex items-center gap-2.5 p-2 rounded-[6px]">
          ...
          <button
            ...
            className="shrink-0 rounded-[5px] p-1.5 relative"
            style={{ color: 'rgba(255,255,255,0.3)', width: 28, height: 28, display: 'flex', alignItems: 'center', justifyContent: 'center' }}
            onMouseEnter={(e) => {
          ...
          >
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
              style={{ position: 'absolute', opacity: mounted && theme === 'dark' ? 1 : 0 }}>
            ...
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
              style={{ position: 'absolute', opacity: mounted && theme === 'light' ? 1 : 0 }}>
